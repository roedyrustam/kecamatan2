...
<body class="hold-transition skin-blue sidebar-mini fixed skin-blue-light">
    <div class="wrapper">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span
                                            class="fa fa-plus"></span> Add waktu</a>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Add Jam Operasional</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url() . 'admin/waktu/simpan_waktu' ?>"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="xhari" class="form-control" id="inputUserName"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="xjam" class="form-control" id="inputUserName"
                                        placeholder="ex =08.00-15.00WIB" required>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id; ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url() . 'admin/waktu/update_waktu' ?>"
                        method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <input type="text" name="xhari" class="form-control" id="inputUserName"
                                        value="<?php echo $hari; ?>" placeholder="Hari" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Jam</label>
                                <div class="col-sm-7">
                                    <input type="text" name="xjam" class="form-control" id="inputUserName"
                                        value="<?php echo $jam; ?>" placeholder="ex= 08.00-15.00WIB" required>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id; ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url() . 'admin/waktu/hapus_waktu' ?>"
                        method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            <input type="hidden" name="kode" value="<?php echo $id; ?>" />
                            <p>Apakah Anda yakin mau menghapus Jam Operasional <b><?php echo $hari; ?></b> ?</p>
