			       ...
			       <div class="carousel-item<?php if ($x == 1) {echo ' active';}?>">
			        ...
			        <div class="container" style="z-index: 1">
			          <div class="carousel-caption">
			            ...
			            <h2><b>Pemerintah Kecamatan Babelan</b></h2>
			          </div>
			        </div>
			      </div>
			    <?php endforeach;?>
...
<div class="marketing">
  <div class="container">
    ...
    <div class="row featurette">
      <div class="col-md-6">
        <img class="featurette-image img-fluid mx-auto" src="assets/images/sambutan/<?php echo $r['gambar'] ?>" alt="Camat Babelan">
      </div>
      <div class="col-md-6">
