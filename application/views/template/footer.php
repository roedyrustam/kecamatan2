<div id="footer" class="footer">
    <div class="container">
        ...
        Copyright &copy; <?php echo date("Y") ?> SiKeCe Babelan | Made with <span i class="fa fa-heart"
...
<script>
window.jQuery || document.write('<script src="<?=base_url('assetss/js/jquery-slim.min.js')?>"><\/script>')
</script>
